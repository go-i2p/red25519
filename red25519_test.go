...
// RFC 8032 §7.1 (TEST 1 through TEST 3). These provide regression protection
...
func TestRFC8032Vector4(t *testing.T) {
	...
	// Full 1023-byte message from RFC 8032 §7.1 TEST 1024.
	msg := hexDecode(t,
...
// TestRFC8032Vector5 tests TEST SHA(abc) from RFC 8032 §7.1, which uses
// SHA-512("abc") as the 64-byte message.
func TestRFC8032Vector5(t *testing.T) {
	...
	// SHA-512("abc") = 64-byte message from RFC 8032 TEST SHA(abc).
	msg := hexDecode(t,
